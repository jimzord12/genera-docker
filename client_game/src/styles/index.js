const styles = {
  ...
  infoText: 'font-rajdhani font-medium text-lg text-[#309123] cursor-pointer',
  ...
  // hocContainer: 'flex xl:flex-row flex-col relative',
  hocContentBox:
    'flex flex-1 justify-between bg-siteblack py-8 sm:px-12 px-8 flex-col',
  hocLogo: 'w-[300px] h-[130px] object-contain cursor-pointer',
  hocBodyWrapper: 'flex-1 flex justify-center flex-col xl:mt-16 my-16',
  ...
  battleGroundsWrapper: 'flex-wrap mt-10 ',
  battleGroundCard:
  ...
  // Game page
  gameContainer:
    'overflow-auto w-screen min-h-screen bg-contain bg-no-repeat bg-center flex-col',
  // gameContainer: 'overflow-auto bg-cover bg-no-repeat bg-center flex-col',
  gameMoveBox:
  ...
  btn: 'px-4 py-2 rounded-lg bg-[#309123] text-3xl text-white font-rajdhani font-bold',

  // custom input component
  label: 'font-rajdhani font-semibold text-2xl text-white mb-3',
  input:
    'bg-siteDimBlack text-white outline-none focus:outline-[#309123] p-4 rounded-md sm:max-w-[50%] max-w-full',
  ...
  gameInfoSidebar:
    'absolute p-6 right-0 top-0 min-h-60 rounded-md flex-col transition-all ease-in duration-300',
  ...
  //background TESTING
  blackBg: 'bg-gradient-to-r from-purple-500 to-pink-500',

  // //good for 1920p monitors
  // bgImg: {
  //   minHeight: '100%',
  //   minWidth: '1920px',
  //   width: '100%',
